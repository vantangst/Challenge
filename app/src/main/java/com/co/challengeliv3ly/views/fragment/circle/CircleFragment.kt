package com.co.challengeliv3ly.views.fragment.circle
...
@ActionBarOptions(
    title = R.string.title_tab_circles,
    left = false
)
@LayoutId(R.layout.fragment_circle)
class CircleFragment : AppFragment<MainViewModel>() {

    private val adapter by lazy { ShapeAdapter(requireContext(), rlMainView) }
    private val type = ShapeType.CIRCLE.value
